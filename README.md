...
**Windows 10 / 11（64 位）：[点击下载安装包](https://github.com/17607106326/xiaoya/releases/latest/download/MyWorkbench_0.1.0_x64-setup.exe)**

双击安装，一路「下一步」即可完成；升级新版本时直接覆盖安装，你的数据不受影响。
